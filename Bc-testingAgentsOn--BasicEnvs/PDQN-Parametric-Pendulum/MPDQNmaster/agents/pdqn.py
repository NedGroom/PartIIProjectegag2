...
class PDQNAgent(Agent):
    ...
    def __init__(self,
        ...
        print("action_parameter_sizes and action_parameter_size")
        print(self.action_parameter_sizes, self.action_parameter_size)
        self.action_max = torch.from_numpy(np.ones((self.num_actions,))).float().to(device)
        self.action_min = -self.action_max.detach()
        print("action_max " + str(self.action_max))
        ...
        print("action param maxes: " + str(self.action_parameter_max_numpy))
        ...
        print("num actions + act param size: " + str(self.num_actions+self.action_parameter_size))
  ...
  #      print(**actor_param_kwargs)
    ...
    #        print(self.epsilon)
            if rnd < self.epsilon:
     #           print("random")
    #            print("self.action_parameter_max_numpy")
    #            print(self.action_parameter_min_numpy)
