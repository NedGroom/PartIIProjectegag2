...
main.main(mode='train', train_eps=500, warmup=15, bsize=64, saveload='runDDPGbaseHindsight1', validate_every=10, validate_eps=30, epsilon=5000, seed=1, loadscaling = 3000, tolerance=0.3)
