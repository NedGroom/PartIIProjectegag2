...
class Memory(object):
    ...
    def append(self, observation, action, reward, terminal, achievedgoal, training=True):
...
class SequentialMemory(Memory):
    def __init__(self, limit, **kwargs):
        ...
        self.achievedGoals = RingBuffer(limit)
    ...
    def append(self, observation, action, reward, terminal, achievedgoal, training=True):
        super(SequentialMemory, self).append(observation, action, reward, terminal, achievedgoal, training=training)
