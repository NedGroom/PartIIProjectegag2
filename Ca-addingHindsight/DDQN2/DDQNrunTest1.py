...
DDQN_discrete.main(batch_size=32, num_sample_eps=6, measure_step=20, num_episodes=1000, saveload='runHDDQNbaseHindsight0', seed=1, update_step=20, loadscaling=3000)
