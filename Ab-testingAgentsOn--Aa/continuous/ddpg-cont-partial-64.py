...
NUM_TRAIN_STEP = 5 # 24 * 365 * 2
EVAL_LEN = 1 # 24*30 # evaluate on 1 month of actions
...
class EvalCallback(BaseCallback):
    def __init__(self, eval_freq = 24*7, verbose=0):
        ...
        self.eval_env = gym.make("bauwerk/SolarBatteryHouse-v0", cfg={"dtype": "float64"})
...
model_ddpg.learn(total_timesteps=NUM_TRAIN_STEP,callback=ddpg_callback,log_interval=10,progress_bar=True)
print("done")
